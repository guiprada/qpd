...
function tilemap_view.draw(self)
    ...
    local vis_start_x, vis_start_y = self.grid:get_point_cell(start_x, start_y)
    local vis_end_x, vis_end_y = self.grid:get_point_cell(end_x, end_y)

    self.tilemap:draw(vis_start_x, vis_start_y, vis_end_x, vis_end_y)
end
